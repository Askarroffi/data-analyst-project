...
def test_convert_temperature(degrees, from_unit, to_unit):
...
convert_temperature_1 = test_convert_temperature(celsius,'C','F')
convert_temperature_2 = test_convert_temperature(fahrenheit,'F','C')
